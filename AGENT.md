...
- The web UI (`apps/frontend` in the backend repository) reads the same
  submodule directory. Thus the backend and the web UI use the same pinned
  commit. There is no npm package and no Buf Schema Registry module.
